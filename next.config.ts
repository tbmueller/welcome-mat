...
const productionHeaders = [
  ...
  { key: "Referrer-Policy", value: "strict-origin-when-cross-origin" },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://apis.google.com",
      "img-src 'self' data: https://maps.googleapis.com https://lh3.googleusercontent.com",
      "frame-src https://trip-tracker-65041.firebaseapp.com https://accounts.google.com",
